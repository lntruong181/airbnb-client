              ...
              <div className={cx('content')}>
                ...
                <div className={cx('summary-fees')}>
                  <div className={cx('fee-box')}>
                    <u className={cx('fee-title')}>$186 x 5 nights</u>
                    <p className={cx('fee')}>$929</p>
                  </div>
                  <div className={cx('fee-box')}>
                    <u className={cx('fee-title')}>Cleaning fee</u>
                    <p className={cx('fee')}>$150</p>
                  </div>
                  <div className={cx('fee-box')}>
                    <u className={cx('fee-title')}>Service fee</u>
                    <p className={cx('fee')}>$152</p>
                  </div>
                </div>
                <div className={cx('total-fee')}>
                  <div className={cx('fee-box')}>
                    <p className={cx('total-title')}>Total before taxes</p>
            ...
            <Wrapper className={cx('analysis-wrapper')}>
              <div className={cx('analysis')}>
                <p className={cx('analysis-heading')}>
                  <strong>Lower price.</strong> Your dates are $163 less than
                  the avg. nightly rate of the last 60 days.
                </p>
                <TagIcon />
              </div>
            </Wrapper>
